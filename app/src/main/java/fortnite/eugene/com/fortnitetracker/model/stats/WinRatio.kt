...
data class WinRatio(
    ...
    companion object CREATOR : Parcelable.Creator<WinRatio> {
        override fun createFromParcel(parcel: Parcel): WinRatio {
            return WinRatio(parcel)
        }

        override fun newArray(size: Int): Array<WinRatio?> {
