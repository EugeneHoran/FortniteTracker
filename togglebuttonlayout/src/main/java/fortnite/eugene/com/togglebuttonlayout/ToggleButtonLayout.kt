package fortnite.eugene.com.togglebuttonlayout
 ...
 */
class ToggleButtonLayout : androidx.cardview.widget.CardView {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        selectedColor = a.getColor(
            ...
            Utils.getThemeAttrColor(context, R.attr.colorControlHighlight)
        )
    ...
    fun inflateMenu(@MenuRes menuId: Int) {
        var selectedToggle: Toggle? = null
        ...
        if (selectedToggle != null)
            setToggled(selectedToggle.id, true)
    }
